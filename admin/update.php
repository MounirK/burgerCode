...
if (!empty($_POST)) {
    ...
    if (empty($price)) {
        $priceError = 'Ce champ ne peut être pas vide';
        $isSuccess = false;
    }
    if (empty($category)) {
    ...
    if (empty($image)) {
        ...
        if (file_exists($imagePath)) {
            $imageError = "Le fichier exists deja";
            $isUploadSuccess = false;
        }
    ...
    <div class="container admin">
        <div class="row">
            <div class="col-sm-6">
                ...
                <form action="<?php echo 'update.php?id='.$id;?>" method="post" class="form" role="form" enctype="multipart/form-data">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <a href="#" class="btn btn-order" role="button">
                            <span class="glyphicon glyphicon-shopping-cart"> Commander</span>
                        </a>
                    </div>
                </div>
            </div>
